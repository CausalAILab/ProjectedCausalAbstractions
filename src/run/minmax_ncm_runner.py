        ...
        with self.lock(f'{d}/lock', lockinfo) as acquired_lock:
            ...
            try:
                ...
                for r in range(hyperparams.get("id-reruns", 1)):
                    ...
                    dat_m = self.dat_model(image_size=hyperparams["img-size"], mode=hyperparams["mode"],
                                           normalize=normalize) # Data generating model
                    ...
                    if verbose:
                        print("DATA")
                        print("Types: {}".format(v_type))
                        for key in dat_set.data:
                            print("{}: {}".format(key, dat_set.data[key].size()))
