...
mode_choices = {"sampling", "sampling_noncausal", "identify", "estimate"}
id_generators = {"mnist"}
id_pipelines = {"gan"}
gan_choices = {"vanilla", "bgan", "wgan", "wgangp"}
gan_arch_choices = {"dcgan", "biggan"}
gan_disc_choices = {"standard", "biggan", "resnet"}
repr_choices = {"none", "auto_enc", "auto_enc_notrain", "auto_enc_conditional"}
type_choices = {
    "real": sdt.REAL,
...
parser.add_argument('--use-projected-cdag', action="store_true", help="use projected CDAG")
...
hyperparams = {
    ...
    'use-projected-cdag': args.use_projected_cdag,
